      ...
      <div className="mt-10 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex flex-wrap gap-3">
          {user?.role === 'organizer' && (
            <a
              href="/organizer"
              className="inline-flex items-center gap-2 px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 transition-colors"
            >
